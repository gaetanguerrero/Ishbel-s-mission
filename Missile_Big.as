package
{
	//Classe qui gère les gros missiles jaunes
	import flash.display.MovieClip;
	import flash.display.Stage;
	import flash.events.Event;
 
	public class Missile_Big extends MovieClip
	{
		...
		private var vitesse:Number = 16;
			...
			//Constructeur
		public function Missile_Big (stageRef:Stage, x:Number, y:Number) : void
		{
			this.stageRef = stageRef;
			this.x = x+50;
			this.y = y+10;
			Moteur.Sounds.jouer_missile_b();
